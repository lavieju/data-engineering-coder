...
import os
import psycopg2
from utils import InsertionResult
...
def insert_data(data_to_load) -> InsertionResult:
    ...
    try: 
        ...
        if rows_loaded == rows_count_to_load:
            ...
            conn.commit()
            return InsertionResult("success", "Data import successful", rows_loaded=rows_loaded).to_dict()
        ...
        print(e)
        return InsertionResult("failed", "Data insertion failed", error=str(e)).to_dict()
